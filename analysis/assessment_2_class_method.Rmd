...
print(top_results)
```
This output is looking at ages over 25...Do I want to do under 25? Need to make sure I do the same analysis with limma though. It doesn't matter if looking at diferent group just flip the negative sign.
